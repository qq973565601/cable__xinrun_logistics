<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="4" :sm="7">
              <a-form-item label="施工单位">
                <a-input placeholder="请输入施工单位" v-model="queryParam.companyName"></a-input>
              </a-form-item>
            </a-col>
          ...
          <a-col :md="7" :sm="10">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button style="margin-left: 8px" type="primary" icon="download" @click="showExportPlan3Modal">导出</a-button>
    ...
    <plan3-modal ref="modalForm" @ok="modalFormOk"></plan3-modal>
