...
public class InventoryServiceImpl extends ServiceImpl<InventoryMapper, Inventory> implements IInventoryService {
    ...
    @Override
    public IPage<InventoryListsVo> InsurancePageList(Integer storageLocationId, Page<InventoryListsVo> page) {
        List<InventoryListsVo> list = baseMapper.InsurancePageList(storageLocationId, page);
