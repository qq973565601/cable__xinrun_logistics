  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading" style="margin-top: 10px">
      <a-form :form="form" style="margin-left: 25px">
        ...
        <a-form-item label="交接日期" :labelCol="labelCol" :wrapperCol="wrapperCol"
        ...
        <a-form-item label="完单重量" v-if="plan4" :labelCol="labelCol" :wrapperCol="wrapperCol"
        ...
        <a-form-item label="入库交接单号" v-if="plan4" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="display: inline-block;width: 500px;margin-left: -27px;margin-right: -183px">
          <a-input v-decorator="['receiptNo',validatorRules.receiptNo]" placeholder="入库交接单号"
                   style="width: 203px"></a-input>
        </a-form-item>
        ...
        <a-form-item label="完单容积" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="operator"
                     style="display: inline-block;width: 430px;margin-left: -13px;margin-right: -30px">
        ...
        <a-form-item label="负责人" v-if="plan4" :labelCol="labelCol" :wrapperCol="wrapperCol"
          ...
          <a-input style="width: 300px" v-decorator="['linkman']" placeholder="请输入负责人"></a-input>
        </a-form-item>
