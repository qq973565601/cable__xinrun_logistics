  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" style="padding-left: 40px;margin-top: 15px">
        ...
        <a-form-item label="任务地址" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="display: inline-block;width: 500px">
          <a-input v-decorator="['address']" placeholder="请输入任务地址"></a-input>
        </a-form-item>

        <a-form-item label="联系人" v-if="phones" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="display: inline-block;width: 300px">
          <a-input v-decorator="['linkman']" placeholder="请输入联系人"></a-input>
        </a-form-item>

        <a-form-item label="电话" v-if="phones" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="display: inline-block;width: 300px">
          <a-input v-decorator="['phone']" placeholder="请输入电话"></a-input>
        </a-form-item>

        <a-form-item label="联系人" v-if="phon" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="display: inline-block;width: 500px;margin-left: 30px">
          <a-input v-decorator="['linkman']" placeholder="请输入联系人"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'linkman', 'phone', 'address', 'realname', 'license', 'a0', 'a1'))
        })
      },
      close () {
        this.visible = false
